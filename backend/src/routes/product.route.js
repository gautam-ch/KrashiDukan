import { addProduct, getProducts, getExpiredProducts, exportProductsCSV, exportProductsPDF, deleteProduct, updateProduct, getProductById } from "../controllers/product.controller.js";
...
router.get('/shops/:shopId/products/expired',verifyToken,catchAsync(getExpiredProducts));
